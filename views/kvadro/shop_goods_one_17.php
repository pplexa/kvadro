<?php
/**
 * Шаблон для вывода одного товара категории 17. - гусеницы
 */
...
<div class="goods-one-end">
    ...
    <div class="goods-propertys"><span>Размер:</span><?php echo $goods[1]['c_23']; ?></div>
    <div class="goods-propertys"><span>Шаг зацепа:</span><?php echo $goods[1]['c_24']; ?></div>
    <div class="goods-propertys"><span>Вес:</span><?php echo $goods[1]['c_22']; ?></div>

...
<?php
if(isset($_SESSION['pages_edit']['res'])){
    echo $_SESSION['pages_edit']['res'];
    unset($_SESSION['pages_edit']['res']);
}
?>
	...
	<table class="add_edit_page" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
		...
		<td><input class="num-text" type="text" name="position" value="<?=$get_page['position']?>" /></td>
          ...
          <tr>
		<td>Url:</td>
		<td><?=URL?>page/<input class="head-text" type="text" name="url" value="<?=$get_page['url']?>" /></td>
	  </tr>
	   <tr>
